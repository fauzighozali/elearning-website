...
<template>
  <div id="page-user-history-course" class="data-list-container">
    ...
    <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="products">
      ...
      <div slot="header" class="flex flex-wrap-reverse items-center flex-grow justify-between">
        ...
        <div class="flex flex-wrap-reverse items-center">
          ...
          <div class="p-3 mb-4 mr-4 rounded-lg cursor-pointer flex items-center justify-between text-lg font-medium text-base text-primary border border-solid border-primary" @click="addNewData">
              ...
              <span class="ml-2 text-base text-primary">Add Event</span>
          </div>
        </div>
      ...
      <template slot="thead">
        <vs-th>No</vs-th>
        <vs-th>Image Event</vs-th>
        <vs-th sort-key="title_event">Title Event</vs-th>
        <vs-th sort-key="description">Description Event</vs-th>
        ...
        <tbody>
          <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
            ...
            <vs-td class="img-container">
              <img :src="tr.img_event" width="150" height="100" class="product-img" />
            </vs-td>

            <vs-td>
              <p class="product-name font-medium truncate">{{ tr.title_event }}</p>
            </vs-td>
